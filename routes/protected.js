...
//routes för att authentisera användaren med hjälp av autenticateToken-funktionen.
router.get("/", authtenticateToken, async (req, res) => {
    res.status(200).json({ message: "Access granted" });
});

//routes för att hämta användarspecifika cv-inlägg med hjälp av användarnamnet som följer med JWT-token som payload och sen authentiseras i authtenticateToken-funktionen
...
//routes för borttagning av cv-inlägg där id skickas med som parameter
...
//routes för att tabort användare och användarspecifika cv-inlägg med hjälp av användarnamnet som följer med JWT-token som payload och sen authentiseras i authtenticateToken-funktionen
...
//routes för att hämta användarinformation med hjälp av användarnamnet som följer med JWT-token som payload och sen authentiseras i authtenticateToken-funktionen
